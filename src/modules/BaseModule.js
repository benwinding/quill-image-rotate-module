export class BaseModule {
    constructor(rotater) {
        this.overlay = rotater.overlay;
        this.img = rotater.img;
        this.options = rotater.options;
        this.requestUpdate = rotater.onUpdate;
    }
    /*
    ...
    /*
        ...
        The overlay has absolute positioning, and will be automatically repositioned and rotated as needed, so you can
    ...
    /*
        onUpdate will be called any time that the element is changed (e.g. rotated, aligned, etc.)

        This frequently happens during rotate dragging, so keep computations light while here to ensure a smooth
        user experience.
     */
    onUpdate = () => {};
}
